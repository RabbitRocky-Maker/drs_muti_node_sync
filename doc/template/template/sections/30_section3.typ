...
#colbreak()
    #[
        #text(font: "Open Sans", 20pt, weight: "bold")[1 Top Header] \ #v(1em)
		#text(font: "Open Sans", 18pt, weight: "bold")[1.1 Sub-Header] \ #v(1em)
		#text(font: "Open Sans", 14pt, weight: "bold")[1.1.1 Subsub-Header] \ #v(1em)
    ]
]
